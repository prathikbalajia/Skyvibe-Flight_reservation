...
const TravellerForm = () => {
    ...
    return (
        <div className="travellerformcontainer" style={{ background: "aliceblue" }}>
            <div><center><p className="travellercount">👥 Number of Travellers: {travelers}</p></center>
            </div>
            ...
            <form className="travellerform" onSubmit={handleSubmit}>
                {formData.map((traveler, index) => (
                    <div key={index} className="travellersection">
                        ...
                        <input type="text" name="email" value={traveler.email} onChange={(e) => handleChange(index, e)} required />
                        <label>Mobile Number:</label>
                        <input type="text" name="mobilenumber" value={traveler.mobilenumber} onChange={(e) => handleChange(index, e)} required />
                        <label>Age:</label>
